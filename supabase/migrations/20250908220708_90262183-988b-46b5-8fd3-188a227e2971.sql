...
-- Find and use an existing referral link, or create a sample click without the foreign key constraint issue
...
SELECT 
  '908b02df-ba5b-4e23-8aec-90401ed04b8e',  -- recommender (current user for testing)
