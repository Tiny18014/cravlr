-- Update the check constraint to allow 'guru_pick' reaction type
ALTER TABLE public.guru_content_reactions 
DROP CONSTRAINT guru_content_reactions_reaction_type_check;

ALTER TABLE public.guru_content_reactions 
ADD CONSTRAINT guru_content_reactions_reaction_type_check 
CHECK (reaction_type IN ('heart', 'drool', 'fire', 'guru_pick'));

-- Now insert sample guru posts from multiple existing gurus
...
VALUES
  ...
  ('post', '22222222-2222-2222-2222-222222222222', 'ee6e85ea-36e4-4071-8682-b406e412655f', 'fire'),
  ('post', '33333333-3333-3333-3333-333333333333', '13daca8a-46ef-49f4-95b5-5dd3f7174858', 'guru_pick'),
  ('post', '33333333-3333-3333-3333-333333333333', '4da2a1aa-c689-4ea3-9d19-7e08a5cf58ad', 'heart'),
  ('post', '44444444-4444-4444-4444-444444444444', 'ee6e85ea-36e4-4071-8682-b406e412655f', 'drool'),
  ...
  ('post', '77777777-7777-7777-7777-777777777777', '4da2a1aa-c689-4ea3-9d19-7e08a5cf58ad', 'guru_pick'),
  ('post', '88888888-8888-8888-8888-888888888888', '5e177c8a-3536-4883-81d8-e6d5b01c2abb', 'heart')
...
VALUES
  ...
  ('66666666-6666-6666-6666-666666666666', '4da2a1aa-c689-4ea3-9d19-7e08a5cf58ad', 'Wow, need this in my life ASAP 😍'),
  ('77777777-7777-7777-7777-777777777777', '5e177c8a-3536-4883-81d8-e6d5b01c2abb', 'Best coffee spot! Love their pastries too')
ON CONFLICT DO NOTHING;