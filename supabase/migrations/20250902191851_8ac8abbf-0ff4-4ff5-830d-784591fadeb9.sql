-- Add missing field to food_requests table
...
ADD COLUMN IF NOT EXISTS points_total INTEGER DEFAULT 0 NOT NULL,
ADD COLUMN IF NOT EXISTS points_this_month INTEGER DEFAULT 0 NOT NULL,
