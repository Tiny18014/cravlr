...
const handler = async (req: Request): Promise<Response> => {
    ...
    try {
                    ...
                    html: `
                        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                            ...
                            <div style="margin: 20px 0;">
                                <a href="https://cravlr.lovable.app/send-recommendation/${requestId}" style="background: #A03272; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">
                                    Recommend a Place
                                </a>
                            </div>
        ...
        if (smsEligibleUsers.length > 0 && ONESIGNAL_APP_ID && ONESIGNAL_API_KEY) {
            const smsMessage = `🍽️ Cravlr: Someone near ${request.location_city} is craving ${request.food_type}! Share your recommendation: https://cravlr.lovable.app/send-recommendation/${requestId}`;
