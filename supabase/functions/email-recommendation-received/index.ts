...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://cravlr.lovable.app/requests/${request.id}/results" style="background: #A03272; color: white; padding: 12px 24px; text-decoration: none; border-radius: 24px; font-weight: bold;">
                View Recommendation
              </a>
            </div>
    ...
    if (requesterProfile.sms_notifications_enabled !== false &&
      ...
      const smsMessage = `🍽️ Cravlr: ${recommenderName} recommended ${recommendation.restaurant_name} for your ${request.food_type} request! Check it out: https://cravlr.lovable.app/requests/${request.id}/results`;
