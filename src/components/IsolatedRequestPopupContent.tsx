...
export const IsolatedRequestPopup: React.FC = () => {
  // First check if we're in a router context by trying to access location
  try {
    useLocation(); // This will throw if not in router context
  } catch (error) {
    // Not in router context, don't render
    return null;
  }
